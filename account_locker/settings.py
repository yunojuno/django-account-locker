...
FAILED_LOGIN_INTERVAL_SECS = getattr(settings, "FAILED_LOGIN_INTERVAL", 60)
...
MAX_FAILED_LOGIN_ATTEMPTS = getattr(settings, "MAX_FAILED_LOGIN_ATTEMPTS", 3)

# the time an account is locked (60s) - used to set cache timeout
ACCOUNT_LOCKED_TIMEOUT_SECS = getattr(settings, "ACCOUNT_LOCKED_TIMEOUT", 60 * 60 * 24)
